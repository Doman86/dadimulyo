            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                        decoration: BoxDecoration(
                            color: outOfStock ? Colors.red[100] : Colors.green[100],
                            borderRadius: BorderRadius.circular(4)),
                        child: Text(outOfStock ? 'Stok Habis' : 'Stok Tersedia',
                            style: TextStyle(
                                fontSize: 11,
                                fontWeight: FontWeight.w600,
                                color: outOfStock ? Colors.red[700] : Colors.green[700])),
                      ),
                    ],
                  ),
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            const Text('Harga eceran', style: TextStyle(color: AppTheme.textSecondary)),
                            Text('${AppTheme.formatRupiah(product.pricePerKg)}/kg',
                        ...
                        if (product.wholesalePrice != null) ...[
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              const Text('Harga grosir', style: TextStyle(color: AppTheme.textSecondary)),
                              Text('${AppTheme.formatRupiah(product.wholesalePrice!)}/kg',
                                  style: const TextStyle(
                                      fontSize: 16, fontWeight: FontWeight.w600, color: AppTheme.secondary)),
                            ],
                          ),
                        ],
                      ],
                  ...
                  // Add to cart
                  if (!outOfStock) ...[
                    Text('Jumlah (kg) — min. ${AppTheme.formatNumber(minOrder)} kg',
                    ...
                    Row(
                      children: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              _quantity = (_quantity - 1).clamp(minOrder, product.stockKg);
                            });
                          },
                        ...
                        Expanded(
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor: _added ? Colors.green : AppTheme.secondary,
                            ),
                            onPressed: _addToCart,
                            child: Text(_added ? '✓ Ditambahkan' : '🛒 Tambah ke Keranjang'),
                          ),
                        ),
                      ],
                    ),
                  ...
                  GridView.count(
                    ...
                    mainAxisSpacing: 8,
                    children: [
                      _specTile('Stok', '${AppTheme.formatNumber(product.stockKg)} kg'),
                      _specTile('Min. Order', '${AppTheme.formatNumber(product.minimumOrderKg)} kg'),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Butuh pesanan dalam jumlah besar?',
                            style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                        const SizedBox(height: 8),
                        const Text('Harga grosir berlaku untuk pembelian di atas minimum order.',
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('Hubungi 0812-3456-7890 untuk pesanan langsung')));
                            },
                            child: const Text('📞 Hubungi 0812-3456-7890'),
                          ),
                        ),
                      ],
                    ),
