    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-20 text-center">
        <Reveal variant="zoom">
          ...
          <h1 className="mt-5 font-display text-2xl font-bold text-charcoal">Keranjang Kosong</h1>
          <p className="mt-2 text-gray-400">Belum ada produk jeruk di keranjang Anda.</p>
    ...
    <div>
      ...
      <section className="page-hero !py-12">
        <div className="relative z-10">
          <Reveal>
            <h1 className="font-display text-3xl font-extrabold text-white">Keranjang Belanja</h1>
          </Reveal>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
                        ...
                        <div>
                          ...
                          <div className="mt-1 text-sm text-gray-400">
                            ...
                            {item.wholesale_price != null && (
                              <span className="ml-2">· Grosir <span className="font-bold text-secondary">{formatRupiah(item.wholesale_price)}/kg</span></span>
                            )}
                          </div>
                          {isBulk && <span className="mt-1 inline-block badge-green">Harga grosir aktif</span>}
                        </div>
          ...
          <Reveal variant="right">
            <aside className="card-lux h-fit p-6 !rounded-2xl lg:sticky lg:top-24">
              <h2 className="font-display text-lg font-bold text-primary">Ringkasan</h2>
              <div className="mt-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-400 text-xs">Ditentukan saat checkout</span>
                </div>
              </div>
              <div className="divider-gold my-4" />
              <div className="flex justify-between">
                <span className="font-bold text-charcoal">Total sementara</span>
