                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    {rental.customer?.phone && (
                      <div className="flex gap-2">
                        <a href={whatsappUrl(rental.customer.phone, `Halo ${rental.customer.name || 'Bapak/Ibu'}, kami dari Dadi Mulyo terkait booking rental truck Anda (ID ${rental.id}).`)} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-500/10 px-3 py-1.5 text-xs font-semibold text-emerald-600 transition-all hover:bg-emerald-500/20">
