                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #eadfc9;">
                    <tr>
                        <td style="padding:32px 32px 8px;text-align:center;">
                            ...
                            <h1 style="margin:16px 0 4px;font-size:20px;color:#1e3f36;">Kode Verifikasi Login</h1>
                    ...
                    <tr>
                        <td style="padding:24px 32px;text-align:center;">
                            <p style="margin:0 0 8px;font-size:14px;color:#555555;line-height:1.6;">
                                Gunakan kode berikut untuk menyelesaikan proses masuk Anda. Kode berlaku selama
                            ...
                            <p style="margin:0;font-size:13px;color:#999999;line-height:1.6;">
                                Abaikan email ini jika Anda tidak sedang melakukan login. Jangan bagikan kode ini kepada siapa pun.
                            </p>
                        </td>
                    </tr>
                    <tr>
