  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : _trucks.isEmpty
              ? const Center(
                  child: Text('Belum ada truck yang disewakan.',
                      ...
                      if (_message != null)
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: _messageSuccess ? Colors.green[50] : Colors.red[50],
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Text(_message!,
                              style: TextStyle(
                                  color: _messageSuccess ? Colors.green[800] : Colors.red[700],
                                  fontSize: 13)),
                        ),

                      const Text('Pilih Truck',
                              ...
                              children: [
                                Container(
                                  ...
                                  child: truck.primaryImageUrl.isNotEmpty
                                      ? ClipRRect(
                                          borderRadius: BorderRadius.circular(6),
                                          child: Image.network(truck.primaryImageUrl,
                                              fit: BoxFit.cover,
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text('${truck.year ?? ''} · ${truck.category?.name ?? ''}',
                      ...
                      if (_selected != null) ...[
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('${_selected!.brand} ${_selected!.model}',
                                  style: const TextStyle(fontWeight: FontWeight.w600)),
                              Text('${AppTheme.formatRupiah(_selected!.rentalPricePerDay ?? 0)}/hari',
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            onPressed: _checking || _startDate == null || _endDate == null
                                ? null
                                : _checkAvailability,
                            child: _checking
                                ? const SizedBox(
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: _submitting || _availability?['available'] != true
                                ? null
                                : _submitBooking,
                            child: _submitting
                                ? const SizedBox(
