...
function ContactActions({ phone, name, message }) {
  ...
  return (
    <div className="mt-2 flex flex-wrap gap-2">
      <a href={whatsappUrl(phone, `Halo ${name || 'Bapak/Ibu'}, kami dari Dadi Mulyo. ${message}`)} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-500/10 px-3 py-1.5 text-xs font-semibold text-emerald-600 transition-all hover:bg-emerald-500/20">
      ...
      <Reveal>
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-400">Ringkasan bisnis Dadi Mulyo.</p>
          </div>
