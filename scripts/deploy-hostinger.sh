...
BACKEND_DIR="${BACKEND_DIR:-/home/u123456789/domains/api.dadimulyo.com/public_html}"
FRONTEND_DIR="${FRONTEND_DIR:-/home/u123456789/domains/dadimulyo.com/public_html}"
...
echo "============================================"
echo ""
echo "Backend API:  https://api.dadimulyo.com"
echo "Frontend:     https://dadimulyo.com"
echo ""
echo "POST-DEPLOY CHECKLIST:"
echo "  1. Edit backend/.env with production DB credentials"
echo "  2. Set SANCTUM_STATEFUL_DOMAINS=dadimulyo.com"
echo "  3. Set FRONTEND_URL=https://dadimulyo.com"
echo "  4. Set APP_URL=https://api.dadimulyo.com"
